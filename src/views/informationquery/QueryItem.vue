...
<template>
  <Container class="query-item" @resize="getTableHeight" :showLeftPadding="false">
    <div class="list">
      <div class="search">
        <div class="pull-left">
          <el-input v-model="params.queryItemName" clearable placeholder="输入名称查询" size="small" class="list-simple-search-input" />
          <el-select v-model="params.queryItemType" @change="refresh(true)" clearable size="small" placeholder="请选择类型" style="width:180px;margin-right:10px">
